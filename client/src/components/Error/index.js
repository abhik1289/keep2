...
export default function Error() {
    ...
    return (
        ...
        <div className="main relative float-right flex-col-reverse">
            {error ? <div className="error_message bg-red-500 p-2 font-main rounded-md text-white">
                {error.message}

            </div> : <button className='capitalize bg-main-color px-4 py-2 font-main rounded-md'
                onClick={() => navigate("/")}
            >
                Go Back
            </button>}
